...
export default async function ChamadoPaiPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div>
      <Link href="/pai/suporte" className="flex items-center gap-1.5 text-sm font-medium text-ink-soft hover:text-navy">
