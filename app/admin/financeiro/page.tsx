  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-ink-soft">
        Taxa de {TAXA_MOVA_PERCENTUAL}% sobre o valor recorrente de cada contrato fechado, mais os extras
        contratados avulso. A cobrança ao responsável é feita via Asaas (Pix, boleto ou cartão) e o repasse
        ao motorista é realizado manualmente.
      </p>
